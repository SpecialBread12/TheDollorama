...
namespace TheDollorama.Content.DamageClasses
{
	public class SprayDamage : DamageClass
	{
		...
		public override void SetDefaultStats(Player player) {
			...
			player.GetCritChance<SprayDamage>() += 4;
			player.GetArmorPenetration<SprayDamage>() += 10;
