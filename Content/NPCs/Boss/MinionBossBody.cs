...
using TheDollorama.Content.BossBars;
...
//using TheDollorama.Content.Pets.MinionBossPet;
	...
	public class MinionBossBody : ModNPC
	{
		...
		public override void SetStaticDefaults() {
			...
			NPCID.Sets.NPCBestiaryDrawModifiers drawModifiers = new NPCID.Sets.NPCBestiaryDrawModifiers() {
				CustomTexturePath = "TheDollorama/Assets/Textures/Bestiary/MinionBoss_Preview",
		...
		public override void SetDefaults() {
			...
			if (!Main.dedServ) {
				Music = MusicLoader.GetMusicSlot(Mod, "Assets/Music/Doom");
			}
		}
		...
		public override void ModifyNPCLoot(NPCLoot npcLoot) {
            ...
            notExpertRule.OnSuccess(ItemDropRule.Common(ModContent.ItemType<DolloramaHelmet>(), 10));
            notExpertRule.OnSuccess(ItemDropRule.Common(ModContent.ItemType<DolloramaBreastplate>(), 10));
            notExpertRule.OnSuccess(ItemDropRule.Common(ModContent.ItemType<DolloramaLeggings>(), 10));
            // This part is not required for a boss and is just showcasing some advanced stuff you can do with drop rules to control how items spawn
            // We make 12-15 ExampleItems spawn randomly in all directions, like the lunar pillar fragments. Hereby we need the DropOneByOne rule,
            // which requires these parameters to be defined
			/*
            int itemType = ModContent.ItemType<CutPotion>();
