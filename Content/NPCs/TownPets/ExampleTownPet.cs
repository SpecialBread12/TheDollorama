...
namespace TheDollorama.Content.NPCs.TownPets
{
	[AutoloadHead]
	public class ExampleTownPet : ModNPC
	{
		...
		public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry) {
			bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[]
			{
				...
				new FlavorTextBestiaryInfoElement("Mods.TheDollorama.Bestiary.ExampleTownPet")
			});
		}
	...
	{
		private static readonly string filePath = "TheDollorama/Content/NPCs/TownPets/ExampleTownPet"; // The path to our base texture.
