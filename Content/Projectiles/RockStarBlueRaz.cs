...
namespace TheDollorama.Content.Projectiles
{
	...
	public class RockStarBlueRaz : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity) {
			...
			*/
			...
			if (Projectile.soundDelay == 0) {
				...
				SoundStyle impactSound = new SoundStyle($"{nameof(TheDollorama)}/Assets/Sounds/Items/SodaCan") {
					Volume = 0.7f,
					PitchVariance = 0.5f,
				};
		...
		public override void PrepareBombToBlow() {
			...
			Projectile.damage = 800; // Bomb: 100, Dynamite: 250
		...
		/*
			...
			if (Projectile.owner == Main.myPlayer && !IsChild) {
				for (int i = 0; i < 5; i++) {
					...
					(child.ModProjectile as RockStarBlueRaz).IsChild = true;
