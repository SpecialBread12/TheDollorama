...
namespace TheDollorama.Content.Tiles.Furniture
{
	...
	public class SupervisorRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "TheDollorama/Content/Tiles/Furniture/SupervisorRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "TheDollorama/Content/Tiles/Furniture/RelicPedestal";
